...
Your workflow will look something like the below. The only differences between this code and the code to calculate the ATE in Question 1 are the `generate()` and `get_p_value()` commands.
